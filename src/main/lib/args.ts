...
export function removeOption<T extends ArgsOptions>(main: keyof T['rules'], args: readonly string[], rules: T) {
  const aliases = [...rules.rules[main as string].aliases || [], main]
